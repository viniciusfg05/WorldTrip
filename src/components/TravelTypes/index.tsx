        ...
        <SimpleGrid w="100%" columns={5}>
            ...
            <ChakraLink href="#" >
                <Flex as="div" align="center" direction="column" w="160px" transform="scale(1.1)">
                    <Image src="/TravelTypes/drink.svg" alt="Vida notura - Imagem de um drink, simbolizando a vida noturna" />
            ...
            <ChakraLink href="#" textDecoration="none">
                <Flex as="div" align="center" direction="column" >
                    <Image src="/TravelTypes/surf.svg" alt="Praia - Imagem de um prancha de surf, simbolizando a prai" />
            ...
            <ChakraLink href="#" textDecoration="none">
                <Flex as="div" align="center" direction="column" >
                    <Image src="/TravelTypes/Predio.svg" alt="Moderno - Imagem de um predio, simbolizando a modernidade" />
            ...
            <ChakraLink href="#" textDecoration="none">
                <Flex as="div" align="center" direction="column" >
                    <Image src="/TravelTypes/museum.svg" alt="Clássico - Imagem de um museu, simbolizando a antiguidade" />
            ...
            <ChakraLink href="#" textDecoration="none">
                <Flex as="div" align="center" direction="column" >
                    <Image src="/TravelTypes/earth.svg" alt="e mais - Imagem da terra" />
